    ...
    JTetris(int pixels) {
		...
		*/
        ...
        registerKeyboardAction(
                e -> tick(LEFT), "left", KeyStroke.getKeyStroke('4'), WHEN_IN_FOCUSED_WINDOW
        );
        registerKeyboardAction(
        ...
        // RIGHT
        registerKeyboardAction(
                e -> tick(RIGHT), "right", KeyStroke.getKeyStroke('6'), WHEN_IN_FOCUSED_WINDOW
        );
        registerKeyboardAction(
        ...
        // ROTATE
        registerKeyboardAction(
                e -> tick(ROTATE), "rotate", KeyStroke.getKeyStroke('5'), WHEN_IN_FOCUSED_WINDOW
        );
        registerKeyboardAction(
        ...
        // DROP
        registerKeyboardAction(
                e -> tick(DROP), "drop", KeyStroke.getKeyStroke('0'), WHEN_IN_FOCUSED_WINDOW
        );
        registerKeyboardAction(
